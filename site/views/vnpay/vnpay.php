    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="views/vnpay/vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <?php
                     ...
                     if($_SESSION['discount']){
                        ...
                        $subTotal = ($subTotal)-($subTotal/100*$discountPercent);
                     }
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">thanh toan don hang <?=$_GET['idhd']?></textarea>
                    </div>
                    <div class="form-group">
