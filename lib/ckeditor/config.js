...
CKEDITOR.editorConfig = function(config) {
    ...
    config.filebrowserBrowseUrl = 'http://localhost/asmphp2/lib/ckfinder/ckfinder.html';
    config.filebrowserUploadUrl = 'http://localhost/asmphp2/lib/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files';
